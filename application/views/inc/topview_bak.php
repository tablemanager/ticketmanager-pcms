    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="ml-n-xs hidden-xs"><a href="#"><i class="fa fa-th-large fa-lg"></i></a></li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#">My Inbox &nbsp;&nbsp;<span class="badge bg-danger animated bounceIn">9</span></a></li>
                        <li class="divider"></li>
                ...
                <li>
                    ...
                    <div id="chat-notification" class="chat-notification hide">
                        <div class="chat-notification-inner">
                            <h6 class="title">
                                <span class="thumb-xs">
                                    <img src="/img/people/a6.jpg" class="img-circle mr-xs pull-left">
                                </span>
                                Jess Smith
                            </h6>
