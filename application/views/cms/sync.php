                    ...
                    <div class="widget-body">
                        <form  role="form" id="insertform" name="insertform" class="form-horizontal" role="form" method="post" action="" >
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="max-length">채널 상품코드</label>
                                    <div class="col-sm-7">
                                        <input type="text" name="chitemcode" id="chitemcode" maxlength="10"
                                               class="form-control"
                                               placeholder="채널상품코드를 입력하세요(옵션)"
                                               data-placement="top" >
                                    </div>
                                </div>
...
?>
		                        ...
		                        <tr>
		                            ...
		                            <td class="hidden-xs">
		                            	<?php 
			                            //if($this->session->userdata('cd') == $row->dam || "penfen" == $this->session->userdata('cd') ){
			                            //if("jjlee" == $this->session->userdata('cd')|| "penfen" == $this->session->userdata('cd') || "yujin" == $this->session->userdata('cd') ){
                                        if(true ){
	...
	echo $row->useyn;
		                            ...
		                            ?>
		                                ...
		                                <ul class="dropdown-menu">
		                                    ...
		                                    <!-- <li class="divider"></li> -->
		                                    <li><a class="n_btn" code="<?=$row->id?>">정지</a></li>
		                                </ul>
		                            </div>
...
$(function(){
	...
	$('#chnpick').change(function(){
		...
		var user = "<?php echo $this->session->userdata('cd');?>";
		 ...
		 if(chnn == "SKP" || chnn == "TMON" || chnn == "WEMP" || chnn == "CPNG" || chnn == "SKT" || chnn == "LEQ" || chnn == "WITH"){
	...
	$('#save_btn').click(function(){
		...
		*/
		...
		if(confirm("등록 하시겠습니까?")){
            ...
            data: {chnpick : chnpick , pcmsitem_id : pcmsitem_id , datetimepicker1 : datetimepicker1 , coupon_id : coupon_id, admin_cd : admin_cd,chitem_id : chitem_id},
            type:"POST",
            success:function(msg)
            {
              $(location).attr('href',msg);
      		    ...
      		    if (res[0] == "err"){
      			  	alert(res[1]);
      			  	$(location).attr('href','/cms/sync/'+chnpick);
      		    }else{
      		    	alert(res[1]);
      		    	//location.reload();
      		    	$(location).attr('href','/cms/sync/'+chnpick);
