		            ...
		            <div class="widget-body">
		                ...
		                <div class="mt">
		                    ...
		                    <table id = "tblCustomers" class="table table-striped table-lg mt-lg mb-0">
		                        <thead>
		                        <tr>
		                        	<th><button type="button" id="dnprice_btn" class="btn btn-inverse">다운로드</button></th>
		                            <th>상품코드</th>
...
$(function(){
	...
	$("#itemname").keyup(function(){
		...
		$.ajax({
	        url: "<?php echo site_url('sys/get_itemname2'); ?>",
	...
	$('#item_select').change(function(){
		...
		//alert(item_id);
		$.ajax({
	        url: "<?php echo site_url('cms/price_load'); ?>",
