                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="faccode"
                                            ...
                                            <?php foreach($faccode as $fack => $facv){ ?>
		                        ...
		                        <tr>
		                            ...
		                            <td>
		                            	<input id="datemode<?=$row->id?>" type="text" class="datemode form-control datetimepicker1" 
		                                    code="<?=$row->id?>" mode = "sdate" maxlength="10" value="<?=$row->sdate?>" size="10" style="border:0; background-color: transparent;"/>
		                            </td>
		                            <td>
		                            	<input id="datemode<?=$row->id?>" type="text" class="datemode form-control datetimepicker1" 
		                                    code="<?=$row->id?>" mode = "edate" maxlength="10" value="<?=$row->edate?>" size="10" style="border:0; background-color: transparent;"/>
		                            </td>
		                            <td class="hidden-xs">
			                            <div class="btn-group">
