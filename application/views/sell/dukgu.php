                    ...
                    <div class="widget-body">
                        <form  role="form" id="insertform" name="insertform" class="form-horizontal" role="form" method="post" action="" >
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="max-length">쏠티상품코드</label>
                                    <div class="col-sm-7">
                                        <input type="text" name="itemcode" id="itemcode" maxlength="30"
                                               class="form-control"
                                               placeholder="상품코드_상세코드 예) 10000747_1189"
                                               data-placement="top">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="max-length">권종</label>
                                    <div class="col-sm-7">

                                        <div class="radio" style="display: inline-block; margin-right: 80px;">
                                            <input type="radio" name="factype" class="factype" id="radio_factype_A" value="A">
                                            <label for="radio_factype_A">
                                                대인
                                            </label>
                                        </div>
                                        <div class="radio" style="display: inline-block; margin-right: 80px;">
                                            <input type="radio" name="factype" class="factype" id="radio_factype_C" value="C">
                                            <label for="radio_factype_C">
                                                소인
                                            </label>
                                        </div>
                                        <div class="radio" style="display: inline-block; margin-right: 80px;">
                                            <input type="radio" name="factype" class="factype" id="radio_factype_N" value="N">
                                            <label for="radio_factype_N">
                                                없음
                                            </label>
                                        </div>
		            	...
		            	<div class="table-responsive">
                            <table id = "tblCustomers" class="table table-striped table-lg mt-lg mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="hidden-xs">쏠티상품코드</th>
		                            <th class="hidden-xs">대/소인</th>
...
$(function(){
	...
	$('#selectchn').change(function(){
		...
		$(location).attr('href','/sell/dukgu/'+selectchn);
	});	
	...
	$('#save_btn').click(function(){
		...
		{
		  alert('쏠티상품코드를 입력해 주세요.');
		  $('#itemcode').focus();
		  return false;
		}
        var factype = $(':radio[name="factype"]:checked').val();
        if(factype == '' || factype == null )
        {
            alert('대/소인을 선택해 주세요.');
            return false;
        }
		...
		if(confirm("등록 하시겠습니까?")){
            ...
            $.ajax({
	        url: "<?php echo site_url('sell/dukgu_add'); ?>",
            ...
            success:function(msg)
            {
                //alert(msg);
      		   ...
      		   $(location).attr('href','/sell/dukgu/'+chncode);
