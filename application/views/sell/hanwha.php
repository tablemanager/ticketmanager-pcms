                    ...
                    <div class="widget-body">
                        <form  role="form" id="insertform" name="insertform" class="form-horizontal" role="form" method="post" action="" >
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="max-length">한화 상품코드</label>
                                    <div class="col-sm-7">
                                        <input type="text" name="itemcode" id="itemcode" maxlength="10"
                                               class="form-control"
                                               placeholder="상품코드 (예:U118046)"
                                               data-placement="top">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="max-length">한화 업장코드</label>
                                    <div class="col-sm-7">
                                        <input type="text" name="gdcode" id="gdcode" maxlength="10"
                                               class="form-control"
                                               placeholder="업장코드 (예1000:)"
                                               data-placement="top">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7"> 
	                                    <input id="startDate" type="text" class="form-control datetimepicker3"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7"> 
	                                    <input id="endDate" type="text" class="form-control datetimepicker3"
...
$(function(){
	...
	$('#save_btn').click(function(){
		...
		if(confirm("등록 하시겠습니까?")){
            ...
            $.ajax({
	        url: "<?php echo site_url('jsell/hanwha_add'); ?>",
            ...
            success:function(msg)
            {
                //alert(msg);
      		   ...
      		   $(location).attr('href','/sell/hanwha/'+chncode);
