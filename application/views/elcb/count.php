...
<div class="content-wrap">
    <main id="content" class="content" role="main">
        <h3 class="page-title"><span class="fw-semi-bold">에버랜드 S티켓 판매/사용 현황 <? if($total != 0)echo $total."건";  ?></span></h3>
        <div class="row">
            <div class="col-md-12">
                <section class="widget">
                    ...
                    <div class="widget-body"> <!-- 상단 검색바 시작  -->
                        ...
                        <form  role="form" id="fform" name="fform" class="form-horizontal" role="form" method="post" action="/elcb/ev_ser" >
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-lg mt-lg mb-0">
                                    ...
                                    foreach($query->result() as $row):
                                        ...
                                        <tr>
                                            <td style="font-size:12px;"><?=$row->ggu?>&nbsp;(<?=$row->sellcode?>)</td>
