<div class="content-wrap">
    <main id="content" class="content" role="main">
        <h3 class="page-title"><span class="fw-semi-bold">"신디 개발중입니다." 뉴스파로 주문 관리 <? if($total != 0)echo $total."건";  ?></span></h3>
        <div class="row">
            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select id="state"
                                                            ...
                                                            <option value="취소접수" <?php echo ($selectdate == '취소접수') ? 'selected' : ''; ?>>취소접수</option>
                                                            <option value="취소" <?php echo ($selectdate == '취소') ? 'selected' : ''; ?>>취소</option>
                                                        </select>
                                                    </div>
