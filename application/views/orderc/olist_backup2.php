                    ...
                    <section class="widget">
                        ...
                        <div class="widget-body">
                            <div class="alert alert-info alert-sm">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                <span class="fw-semi-bold">Info: </span> 주문번호를 클릭하면 <span class="fw-semi-bold">상세페이지</span>를 볼 수 있습니다.
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-lg mt-lg mb-0">
                                    ...
                                    foreach($query->result() as $row):
										...
										<?php }?>
											<td class="nm<?=$row->id?> hidden-xs" style="font-size:12px;" name="nm"><?=$row->usernm?>
                                            </td>
											<td class="hp<?=$row->id?> hidden-xs" style="font-size:12px;" name="hp"><?=$row->dhp?>
                                            </td>
                                                        ...
                                                        <div class="modal-body bg-gray-lighter">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group">
																	...
																	<label class="col-sm-3 control-label" for="company_select" style="margin-top: 10px">예약번호</label>
																	<div class="col-sm-7">
        ...
        $('#excel_btn').click(function(){
			...
			var dammemo = $('#dammemo').val();
             ...
             $.ajax({
				...
				data:{selectdate:selectdate,sdate:sdate,edate:edate,usedate:usedate,usernm:usernm,userhp:userhp,orderno:orderno,barcodeno:barcodeno,grnm:grnm,jpnm:jpnm,itemnm:itemnm,chnm:chnm,
					ch_orderno:ch_orderno,state:state,usegu:usegu,dammemo:dammemo},
                type:"POST",
                success:function(msg)
                {
//                    alert(msg);
