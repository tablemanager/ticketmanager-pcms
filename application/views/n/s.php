	...
	<div class="row">
		...
		<div class="col-md-6">
			<section class="widget">
				<div class="widget-body" >
					...
					<form  role="form" id="fform" name="fform" class="form-horizontal" role="form" method="post" action="/n/s" >
						<fieldset>
		...
		$ip = $_SERVER["REMOTE_ADDR"];
			...
			<div class="paging_bootstrap">
				<ul class="pagination">
					<li><a href="http://pcms.placem.co.kr/index.php/n/s">처음으로</a></li>
					<li><a href="http://pcms.placem.co.kr/index.php/n/s/T">입금확인중</a></li>
					<li><a href="http://pcms.placem.co.kr/index.php/n/s/U">무통장 입금확인중</a></li>
					<li><a href="http://pcms.placem.co.kr/index.php/n/s/calls">통화불능 리스트</a></li>
					<li><a href="http://pcms.placem.co.kr/index.php/n/s/chk">이슈발생 주문리스트</a></li>
					<li><a href="http://pcms.placem.co.kr/index.php/n/s/oks">입금확인완료 주문리스트</a></li>
				</ul>
			</div>
...
//							$show = "hide";
							...
							$sql = "SELECT * FROM cmsdb.refund_order where cushp = '{$row->cushp}' and pay_type in ('{$pay_type_arr_q}')";
							$sql = "SELECT * FROM cmsdb.refund_order where cushp = '{$row->cushp}' ";
							$qry = $rds->query($sql);
...
$(function(){
	...
	$('#excel_btn').click(function(){
		...
		var excelurl = '<?php echo site_url('n/s_p'); ?>';
	...
	$('#excel_btn_all').click(function(){
		...
		var excelurl = '<?php echo site_url('n/s_a'); ?>';
		window.location.assign(excelurl);
	});
	$('#excel_btn_ok').click(function(){

		var excelurl = '<?php echo site_url('n/s_a/ok'); ?>';
		window.location.assign(excelurl);
	});
	...
	$(".sms_send").click(function() {
		...
		if(confirm(hp+"님에게 아래내용으로 문자를 보내시겠습니까?\r\n==============================\r\n"+text)){
			$.ajax({
				url: "<?php echo site_url('n/send_sms'); ?>",
	...
	$(".sms_btn").click(function() {
		...
		$.ajax({
			url: "<?php echo site_url('n/get_sms_type'); ?>",
	...
	$('.state').change(function(){
		...
		$.ajax({
			url: "<?php echo site_url('n/s_mode'); ?>",
	...
	$('.memo_btn').click(function(){
		...
		$.ajax({
			url: "<?php echo site_url('n/s_memo'); ?>",
