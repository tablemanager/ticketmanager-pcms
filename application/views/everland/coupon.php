                ...
                <section class="widget">
                    ...
                    <div class="widget-body"> <!-- 상단 검색바 시작  -->
                        <div class="alert alert-success alert-sm">
                            ...
                            <span class="fw-semi-bold"> 에버랜드 쿠폰(QR)상태를 조회 할 수 있습니다. : 해외 B2B 포함  , 최대 500매까지 조회 해주세요. 서버가 느려질 수 있습니다.</span>
                        </div>
                        <form  role="form" id="fform" name="fform" class="form-horizontal" role="form" method="post" action="/order/ordser" >
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    ...
                                    <button type="button" id="bar_ccl" class="btn btn-inverse" style="margin-top: 25px">쿠폰 조회</button>
                                </div>
    ...
    $(function(){
        ...
        $("#bar_ccl").click(function(){
            ...
            if(barcodetxt == '' || barcodetxt == null){
                ...
                $.ajax({
                    url: "<?php echo site_url('everland/coupon_search'); ?>",
